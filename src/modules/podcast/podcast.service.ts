...
export class PodcastService {
    ...
    async uploadPodcast(
        ...
        try {
            ...
            // Validate file
            const validation = this.validateAudioFile(audioFile, podcastClient);
            ...
            if (podcastClient.usedStorageMb + fileSizeMb > podcastClient.maxStorageMb) {
                return {
                    error: true,
                    data: null,
            ...
            const podcast = this.podcastRepository.create({
                ...
                clientId: podcastClient.clientId,
                uploadedBy,
            });
            ...
            await this.podcastClientRepository.update(podcastClient.clientId, {
                usedStorageMb: podcastClient.usedStorageMb + fileSizeMb,
            });
