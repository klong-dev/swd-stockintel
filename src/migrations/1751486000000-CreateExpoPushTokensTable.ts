...
export class CreateExpoPushTokensTable1751486000000 implements MigrationInterface {
    name = 'CreateExpoPushTokensTable1751486000000'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE UNIQUE INDEX IF NOT EXISTS "IDX_expo_push_tokens_token" ON "expo_push_tokens" ("token")
        `);
    }
